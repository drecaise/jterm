...
/**
 * A top-level window that hosts a tab strip of terminal grids: the single main window or a detached
 * window. A window topology tracks these so tabs can move between windows and the global shortcut
 * dispatcher can target whichever window is focused.
 */
