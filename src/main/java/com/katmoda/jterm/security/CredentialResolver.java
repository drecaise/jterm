...
public final class CredentialResolver {
    ...
    public interface Prompts {
        char[] promptSessionPassword(String sessionName);                    // null = cancelled
    ...
    public String resolvePassword(SshSessionConfig cfg) {
        ...
        char[] entered = promptSessionPasswordOnEdt(cfg.getName());
        if (entered == null) {
            return null;
        }
    ...
    private String resolvePassword(String id, boolean passwordAuth, boolean savePassword,
        ...
        char[] entered = promptSessionPasswordOnEdt(promptName);
        if (entered == null) {
            return null;
        }
        String password = new String(entered);
    ...
    private char[] promptSessionPasswordOnEdt(String sessionName) {
        char[][] holder = new char[1][];
        runOnEdt(() -> holder[0] = prompts.promptSessionPassword(sessionName));
        return holder[0];
    }
